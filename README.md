This shell prgroam is an implemention of a linux shell, it behaves similarly to what a real shell would do. This program (Myshell) has two modes, interactive and batch mode. 
